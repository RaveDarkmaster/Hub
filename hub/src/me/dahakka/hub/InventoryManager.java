  ...
  implements Runnable
{
  ...
  private void SecondRun(Inventory inv)
  {
    ...
    inv.setItem(11, Utils.createItem(new ItemStack(Material.DIAMOND_BLOCK), 
      ChatColor.AQUA + ChatColor.BOLD + "Blocks Shop", Arrays.asList(new String[] { ChatColor.LIGHT_PURPLE + "Blocky things" })));
    inv.setItem(15, Utils.createItem(new ItemStack(Material.ENDER_PEARL), 
      ChatColor.GOLD + ChatColor.BOLD + "Item Shop", Arrays.asList(new String[] { ChatColor.LIGHT_PURPLE + "Stuff..." })));
  }
  ...
  private void FirstRun(Inventory inv)
  {
    Log.info(
      ...
      new Object[] { "First Run" });Utils.fillAirWithItem(inv, DyeColor.BLACK, 0, inv.getSize() - 1);inv.setItem(4, Utils.createItem(new ItemStack(Material.TNT), ChatColor.RED + ChatColor.BOLD + "Factions", Arrays.asList(new String[] { ChatColor.LIGHT_PURPLE + "Needs Staff!" })));inv.setItem(9, Utils.createItem(new ItemStack(Material.STICK), ChatColor.LIGHT_PURPLE + ChatColor.BOLD + "Velaria", Arrays.asList(new String[] { ChatColor.LIGHT_PURPLE + "Coming Soon" })));inv.setItem(11, Utils.createItem(new ItemStack(Material.IRON_FENCE), ChatColor.AQUA + ChatColor.BOLD + "Prison", Arrays.asList(new String[] { ChatColor.RED + "Op Prison." })));inv.setItem(15, Utils.createItem(new ItemStack(Material.BLAZE_POWDER), ChatColor.DARK_RED + ChatColor.BOLD + "MagnumCraft", Arrays.asList(new String[] { ChatColor.DARK_RED + ChatColor.BOLD + "Ultra Hardcore Bending." })));inv.setItem(17, Utils.createItem(new ItemStack(Material.GRASS), ChatColor.GREEN + ChatColor.BOLD + "Skyblock", Arrays.asList(new String[] { ChatColor.AQUA + "Razberry's Skyblock." })));inv.setItem(22, Utils.createItem(new ItemStack(Material.BEACON), ChatColor.GOLD + ChatColor.BOLD + "Creative", Arrays.asList(new String[] { ChatColor.LIGHT_PURPLE + ChatColor.BOLD + "NEW " + ChatColor.GOLD + "Build with friends or marry someone!" })));inv.setItem(26, Utils.createItem(new ItemStack(Material.CHAINMAIL_CHESTPLATE), ChatColor.DARK_GREEN + ChatColor.BOLD + "KitPVP", Arrays.asList(new String[] { ChatColor.LIGHT_PURPLE + "Yet To Be Announced." })));inv.setItem(24, Utils.createItem(new ItemStack(Material.GOLD_BLOCK), ChatColor.DARK_GREEN + ChatColor.BOLD + "Shop", Arrays.asList(new String[] { ChatColor.RED + ChatColor.UNDERLINE + "http://reigncrafted.enjin.com/shop" })));
  }
}
